                ...
                for (let u in urls) {
                    ...
                    if (alreadyProcessed.indexOf(url) < 0) {
                        ...
                        for (urlVariation of urlVariations) {
                            ...
                            await browser.close();
                            const latestResults = this.analyzeHtml(url, urlVariation, html);

                            if (latestResults.data.length > 0) {
                                totalResults.push(latestResults);
                                console.log("Add sinks for " +  urlVariation.mutatedUrl);
                            } else {
